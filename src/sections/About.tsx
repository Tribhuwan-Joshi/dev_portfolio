...
function About() {
  return (
    <section
      id="about"
      className="h-[100%] border-b-[1px] p-[3rem]  flex  items-center sm:items-center border-[#dee2e6]"
    >
      <div className="content space-y-12">
        ...
        <p className=" text-[#666b6f]" style={{ fontFamily: "Open sans" }}>
          ...
          proposition. I am dedicated to producing high-quality and scalable
        ...
        <ul className="icons flex gap-5 w-[20%] min-w-[200px] mt-[5rem] h-[100px]">
          <li>
            <a
              ...
              target="_blank"
            >
              <div className="bg-[#495057] w-[3rem] h-[3rem] rounded-full flex justify-center items-center hover:bg-[#bd5d38]">
